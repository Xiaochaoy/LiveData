...
import com.example.p_livedata.R;
                ...
                if(!ejercicio.equals(ejercicioAnterior)){
                    ...
                    switch (ejercicio) {
                        ...
                        case "EJERCICIO5":
                            ...
                            break;
                        case "EJERCICIO6":
                            imagen = R.drawable.e6;
                            break;
                        case "EJERCICIO7":
                            imagen = R.drawable.e7;
                            break;
                        case "EJERCICIO8":
                            imagen = R.drawable.e8;
                            break;
                        case "EJERCICIO9":
                            imagen = R.drawable.e9;
                            break;
                        case "EJERCICIO10":
                            imagen = R.drawable.e10;
                            break;
                        case "EJERCICIO11":
                            imagen = R.drawable.e11;
                            break;
                        case "EJERCICIO12":
                            imagen = R.drawable.e12;
                            break;
                    }
